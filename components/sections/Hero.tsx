  ...
  return (
    <section id="top" className="relative min-h-svh overflow-x-clip px-4 pb-16 pt-24 sm:px-5 md:px-8 md:pb-24 md:pt-36">
      ...
      <div className="relative z-10 mx-auto min-w-0 max-w-6xl">
        <h1 className="w-full text-center font-display text-[clamp(2rem,11vw,6.5rem)] font-extrabold uppercase leading-[0.88] tracking-[-0.06em]">
        ...
        <div className="mt-8 grid min-w-0 gap-6 sm:mt-12 lg:mt-16 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.15fr)_minmax(0,0.9fr)] lg:grid-rows-[auto_auto] lg:gap-x-6 lg:gap-y-0">
          <div className="order-2 flex max-w-sm flex-col justify-center lg:order-none lg:col-start-1 lg:row-span-2 lg:self-center">
          ...
          <div className="order-1 mx-auto w-full max-w-sm lg:order-none lg:col-start-2 lg:row-start-1 lg:max-w-none">
          ...
          <ul className="order-3 flex flex-col gap-3 lg:order-none lg:col-start-3 lg:row-start-1 lg:h-full">
            {hero.skills.map((skill) => (
              <li
                key={skill}
                className="flex flex-1 items-center justify-center rounded-lg border border-white/10 bg-white/[0.06] px-4 py-3 text-center text-sm text-ink/90 sm:py-6"
              >
                {skill}
              </li>
            ))}
          ...
          <div className="order-4 mx-auto w-[92%] max-w-sm lg:order-none lg:col-start-2 lg:row-start-2 lg:w-[92%] lg:max-w-none">
        ...
        <p className="mt-12 max-w-4xl font-serif text-xl italic leading-snug text-ink/90 md:mt-24 md:text-4xl">
          {hero.manifesto}
        </p>
